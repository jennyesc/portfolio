...
<h4>Research</h4>
    ...
    <h4>Planning</h4>
        <p>I first wrote a content plan and created wireframes for the mobile version of the site. After finalizing the Initial
...
<div class="panel">
  <p>As mentioned in the above summary, my designs choices are based on the paintings by Piet Mondrian. 
    ...
    <section class=logo-container>
        <img src="images/jennyescobell-logo.jpg" alt="Jenny Escobell logo">
    </section>
  
    <section class="colour-container">
        <h4>Colour Palette </h4>
        <div class="colour-1"> <p>#BF212E</p> </div>
        <div class="colour-2"><p>#304673</p></div>
        <div class="colour-3"><p>#F2B90C</p></div>
        <div class="colour-4"><p>#f2f2f2</p></div>
    </section>
...
<div class="panel">
    ...
    <h4>Development</h4>
    <p>Once the designs were complete, I began entering all the HTML code, using HTML5 semantics. As I was entering the HTML content, I realized that
        this would be a good opportunity to use Trello and keep track of this project. 
    </p>
