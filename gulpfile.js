...
exports.build = series(parallel(sassTask, jsTask), setBuildState, cleanTask, parallel(sassTask, jsTask, jQueryTask), parallel(htmlTask, imagesTask, mediaTask, fontsTask), cacheBustTask);
